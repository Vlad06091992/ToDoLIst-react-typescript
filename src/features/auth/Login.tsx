...
import { authThunks, getCaptchaUrl } from "./auth-reducer";
import { Navigate } from "react-router-dom";
import { Button, Checkbox, FormControl, FormControlLabel, FormGroup, FormLabel, Grid, TextField } from "@mui/material";
import { captchaUrl, selectIsLoggedIn } from "features/auth/auth-selectors";
...
export const Login = () => {
  ...
  const captcha = useSelector(captchaUrl);
  const formik = useFormik({
    ...
    onSubmit: (values, formikHelpers: FormikHelpers<LoginParamsType>): void => {
      login(values)
        .unwrap()
